...
$sql = "SELECT * FROM evenimente WHERE categorie='Festival' AND cantitate>0";
    ...
    <nav class="box-shadow">
      <div>
        <ul class="menu">
          ...
          <li class="current"><a href="services.php">Events</a></li>
  ...
  <section id="content">
   ...
   <div class="row">
      ...
      <div class="col-md-2">
       ...
       <div class="col-md-2">
        <?php
     $fest = "SELECT * FROM categorie";
     $fest_quer = $conn->query($fest);
     ?>
         <div class="dropdown">
          <button class="btn btn-secondary dropdown-toggle btn-details" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
           Event type
          </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <?php while($row = mysqli_fetch_assoc($fest_quer)) : ?>
              <a class="dropdown-item" href="<?php echo $row['categorie']; ?>.php"><?php echo $row['categorie']; ?></a>
              <?php endwhile; ?>
